...
Drugą częścią modelu ARIMA jest I(integrated), odnosi się różnicowania celem uczynienia szeregu czasowego stacjonarnym. MA (Moving Average) odnosi się do modelu, który wykorzystuje zależność między bieżącą wartością a wcześniejszymi błędami losowymi. 
<br>
